...
RUN rpm -Uvh /root/rpmbuild/RPMS/x86_64/varnish-4.1.1-1.el7.centos.x86_64.rpm /root/rpmbuild/RPMS/x86_64/varnish-libs-4.1.1-1.el7.centos.x86_64.rpm /root/rpmbuild/RPMS/x86_64/varnish-libs-devel-4.1.1-1.el7.centos.x86_64.rpm
...
RUN git clone https://github.com/varnish/libvmod-curl.git && cd libvmod-curl && git checkout 4.1
...
RUN git clone https://github.com/varnish/libvmod-header.git && cd libvmod-header && git checkout 4.1
